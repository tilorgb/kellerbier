...
const GROUPS: readonly GroupSpec[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'velocityInheritance', min: 0, max: 1.5, step: 0.05, hint: 'sway while strafing' },
    ...
    fields: [
      {
        ...
        max: 8,
        step: 1,
        hint: 'stagger on a hit (local, not a freeze)',
      },
      { key: 'hitstunPerDamage', min: 0, max: 3, step: 0.1, hint: 'extra stagger per damage' },
      { key: 'maxHitstunTicks', min: 0, max: 12, step: 1, hint: 'stagger ceiling' },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'deflectShake', min: 0, max: 3, step: 0.05, hint: 'shake off a shell' },
      {
        ...
        max: 1,
        step: 0.01,
        hint: 'elite roll chance, Floor 1 (#156)',
      },
      {
        key: 'eliteChancePerExtraFloor',
        min: 0,
        max: 0.5,
        step: 0.01,
        hint: 'added per floor past the first',
      },
      { key: 'eliteChanceMax', min: 0, max: 1, step: 0.01, hint: 'elite roll ceiling' },
      { key: 'eliteHealthMultiplier', min: 1, max: 4, step: 0.1, hint: 'elite health' },
      {
        key: 'eliteContactDamageMultiplier',
        min: 1,
        max: 3,
        step: 0.1,
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'massHalfAmount', min: 0, max: 3, step: 0.1, hint: 'Promille per half Maß' },
      {
        ...
        max: 2,
        step: 0.5,
        hint: 'Trinkfest (#92) — the tolerance slider',
      },
      {
        key: 'trinkfestStageWidth',
        min: 0.25,
        max: 2,
        step: 0.05,
        hint: 'Promille per Trinkfest level',
      },
      ...
      {
        key: 'sturzbesoffenDamageBonus',
        min: 0,
        max: 3,
        step: 0.05,
        hint: '+dmg, Sturzbesoffen (Trinkfest 1)',
      },
      {
        key: 'sturzbesoffenFireRateBonus',
        min: 0,
        max: 3,
        step: 0.05,
        hint: '+fire rate, Sturzbesoffen',
      },
      {
        key: 'filmrissDamageBonus',
        min: 0,
        max: 3,
        step: 0.05,
        hint: '+dmg, Filmriss (Trinkfest 2)',
      },
      {
        key: 'filmrissFireRateBonus',
        min: 0,
        max: 3,
        step: 0.05,
      ...
      { key: 'swayPeriodTicks', min: 10, max: 600, step: 10, hint: 'ticks per sway loop' },
      {
        ...
        max: 3,
        step: 0.05,
        hint: 'screen distortion at full ramp',
      },
      {
        key: 'screenDistortionPeriodTicks',
        min: 5,
        max: 200,
        step: 5,
        hint: 'ticks per distortion pulse',
      },
      {
  ...
  },
  {
    ...
    fields: [
      ...
      {
        key: 'bombBlastArmTiles',
        min: 1,
        max: 5,
        step: 1,
        hint: 'blast reach, tiles each direction',
      },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'luckQualityBias', min: 0, max: 0.5, step: 0.01, hint: 'Luck skews toward rarity' },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'legendaryWeight', min: 0, max: 100, step: 1, hint: 'base weight, rarest outcome' },
      {
        ...
        max: 0.5,
        step: 0.01,
        hint: 'Luck skews away from bad luck',
      },
