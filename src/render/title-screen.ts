...
export class TitleScreen implements MenuScreen {
  ...
  constructor(kit: UiKit, actions: TitleScreenActions, options: TitleScreenOptions = {}) {
    ...
    this.menu = new Menu(kit, items, { face: 'display', minWidth: MENU_MIN_WIDTH });
    this.view.addChild(this.menu.view);

    this.footer = uiText('A Bavarian cellar-crawling roguelike', { colour: UI_PALETTE.textDim });
